                    ...
                    <tr>
                        ...
                        <td class="pe-4 text-end">
                            <div class="d-flex gap-2 justify-content-end align-items-center">
                                ...
                                <form action="{{ route('admin.schools.generate_demo', $school->id) }}" method="POST" onsubmit="return confirm('¿Crear o restablecer usuario demo (demo_{{ $school->slug }}@gentepiola.net) para esta empresa?');">
                                    @csrf
